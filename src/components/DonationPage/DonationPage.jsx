...
import './donation.css'
import donation from "../../lotteAnimation/donation.json";
import thankyou from "../../lotteAnimation/thankyou.json";
import donateLoading from "../../lotteAnimation/donateLoading.json";
...
function DonationPage() {
    ...
    const [afterDonate, setafterDonate] = useState(false)
    ...
    return (loading ? afterDonate ?
        ...
        (<Box sx={{ height: "100%", width: "100%" }}>
            ...
            <Box sx={{ display: "flex", height: "90%", width: "100%" }}>
                ...
                <Box sx={{ width: "50%", padding: "1rem", display: "flex", justifyContent: "center", alignItems: "center" }} >
                    ...
                    <Typography style={{ position: "absolute" }} fontWeight={"bold"} variant="h2" gutterBottom>
                        <TypeAnimation
                            style={{ color: "black" }}
                            sequence={[
                                'Make a Donation',
                                1000,
                                () => setTextColor('#00ffff99'),
                                'Save Water.',
                                1000,
                                () => setTextColor('#ffffff8c'),
                            ]}
                            repeat={Infinity}
                            cursor={true}
                        />
                    ...
                    <div className="modal">
                        <form className="form">
                            ...
                            <div className="credit-card-info--form">
                                ...
                                <div className="input_container">
                                    <label htmlFor="password_field" className="input_label">Amount</label>
                                    <div className="split">
                                        <input id="password_field" className="input_field" type="number"  title="Amount" placeholder="Amount" />
                                    </div>
                                </div>
                            </div>
                            <Button onClick={handleDonate} color='warning' variant='contained' className="purchase--btn">Donate</Button>
                        </form>
                    </div>
                </Box>
            </Box>
