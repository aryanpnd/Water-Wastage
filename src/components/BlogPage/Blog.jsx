...
import { Card, CardActionArea, CardContent, CardMedia, Grid, Typography, Input, LinearProgress, Paper, Snackbar, Tooltip, } from '@mui/material';
                ...
                {loading1 ?
                    (<>
                        ...
                        <Box sx={{
                            ...
                            <div style={{ height: "100%", width: "100%", display: "flex", justifyContent: "space-evenly", flexWrap: "wrap" }}>
                                {news.map((article, index) => {
                                    if (news.length === index + 1) {
                                        return (
                                            <Tooltip title="Read More.." arrow>
                                        <Paper ref={lastNewsElementRef} className="myAnim" elevation={10} 
                                        onClick={() => { window.open(article.url, '_blank') }}
                                        sx={{
                                            display: "inline-block", background: "#061b3cb8", color: "#a3a3a3", padding: "1rem", width: "15%",borderRadius:"10px",height: "45%", wordWrap: "break-word", margin: "1rem",
                                            cursor:"pointer"
                                        }}>
                                            <div style={{
                                                width: "100%",
